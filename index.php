...
<body>
    ...
    <main id="main">
        <section class="section">
            ...
            <p>Content</p>
            <p>Content</p>
            <p>Contentfkfffffffffffffffffsffkfffffff ffffffffffsffkffffffffff aaaaaafffffffsffkffffffffff fffffffsffkfffffffffffffff ffsffkfffffffffffffffffsffkfff ffffffffffffffsffkfffffffffffffffffsf</p>
            <p>Content</p>
            <p>Content</p>
            <p>Content</p>
            <p>Content</p>
    ...
    <script>
        ...
        {
            document.getElementById("index").id = "active";
        }
